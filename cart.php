...
<section class="products shopping-cart">
   ...
   <div class="cart-total">
      <p>Total geral : <span>$<?= $grand_total; ?>/-</span></p>
      <a href="shop.php" class="option-btn">Continuar comprando</a>
      <a href="cart.php?delete_all" class="delete-btn <?= ($grand_total > 1)?'':'disabled'; ?>" onclick="return confirm('excluir todos do carrinho?');">Excluir todos os itens</a>
      <a href="checkout.php" class="btn <?= ($grand_total > 1)?'':'disabled'; ?>">Continuar para a compra</a>
   </div>
